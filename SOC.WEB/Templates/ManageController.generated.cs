...
namespace SOC.WEB.Controllers {
    public partial class ManageController {
        ...
        public class ViewNames {
            public readonly string BottomPanel = "~/Views/Manage/BottomPanel.cshtml";
            public readonly string Index = "~/Views/Manage/Index.cshtml";
            public readonly string Navigation = "~/Views/Manage/Navigation.cshtml";
            public readonly string TopNavBar = "~/Views/Manage/TopNavBar.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_ManageController: SOC.WEB.Controllers.ManageController {
