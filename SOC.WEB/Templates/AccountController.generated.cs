...
namespace SOC.WEB.Controllers {
    ...
    public class T4MVC_AccountController: SOC.WEB.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult Login(SOC.WEB.Models.LoginModel model, string returnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Login);
        ...
        public override System.Web.Mvc.ActionResult Register(SOC.WEB.Models.RegisterModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Manage(SOC.WEB.Controllers.AccountController.ManageMessageId? message) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "message", message);
            return callInfo;
        }

        public override System.Web.Mvc.ActionResult Manage(SOC.WEB.Models.LocalPasswordModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(SOC.WEB.Models.RegisterExternalLoginModel model, string returnUrl) {
